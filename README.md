...
export ZKILL_R2Z2_URL='https://r2z2.zkillboard.com/ephemeral/'
...
ZKILL_R2Z2_URL='https://r2z2.zkillboard.com/ephemeral/' \
...
docker run \
  ...
  --env ZKILL_R2Z2_URL='https://r2z2.zkillboard.com/ephemeral/' \
